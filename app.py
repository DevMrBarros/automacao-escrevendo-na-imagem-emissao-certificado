...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)):
    ...
    # Substitua o caminho do projeto para o caminho salvo no seu computador
    image.save(f'C:\Projetos_Programacao\Automação_python\AutomacaoCertificados\Certificados Automatizados/{indice} {nome_participante} certificado.png')
